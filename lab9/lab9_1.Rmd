...
```{r}
setwd("~/Documents/GitHub/BIS15L_W26_aehall/lab9/data")
relig_income <- read_csv("relig_income.csv")
```

2. Why are these data untidy?
Income should be its own column instead of split up into separate columns.
...
relig_income <- relig_income %>%
  pivot_longer(-religion,  #don't move
               ...
               values_to = "total")  #move count into new col
```
...
qpcr_tidy <- qpcr_untidy %>%
  pivot_longer(
    ...
    names_sep = "_",  #separate into two cols
