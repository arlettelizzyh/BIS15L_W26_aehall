...
```{r}
p+geom_point(size=2, color="black", alpha=0.7, shape=24, fill="cornsilk2")
```

```{r}
colors() #see what colors exist
```
...
homerange %>%
  ...
  geom_bar(na.rm=T)+
  coord_flip()+
  labs(x="Taxon Group", y=NULL, title="Number of Observations by Taxon")
```
