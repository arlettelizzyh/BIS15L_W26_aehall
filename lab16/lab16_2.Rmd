...
7. Check the **Select All** box. Click on Download and select the **Descriptions Table (CSV)**. Download the results in CSV format. Using the command line move the file into your "data/blast_results" folder and rename the file to "genome01_blastn.csv".
```{}
mv genome01_blastn.csv BIS15L_W26_aehall/lab16/data/blast_results/
ls BIS15L_W26_aehall/lab16/data/blast_results/
```
...
```{r}
genome01_blastn <- read_csv("~/Desktop/BIS15L_W26_aehall/lab16/data/blast_results/genome01_blastn.csv") %>%
  clean_names()
```
...
```{r}
dna_file <- readDNAStringSet("~/Desktop/BIS15L_W26_aehall/lab16/data/e.coli_genbank.fasta")
```
...
```{r}
aa_file <- readAAStringSet("~/Desktop/BIS15L_W26_aehall/lab16/data/e.coli_cds.fasta")
```
...
```{}
mv blastp_results.csv BIS15L_W26_aehall/lab16/data/blast_results/
ls BIS15L_W26_aehall/lab16/data/blast_results/
```
...
```{r}
blastp_results <- read_csv("~/Desktop/BIS15L_W26_aehall/lab16/data/blast_results/blastp_results.csv") %>%
  clean_names()
```
