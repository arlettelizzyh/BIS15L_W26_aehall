...
```{r}
display.brewer.pal(12,"Set3") #qualitative palette
```
...
```{r}
my_palette <- paletteer_d("calecopal::wetland")
my_palette
```
...
```{r}
my_palette <- paletteer_d("calecopal::seagrass")
my_palette
```
```{r}
