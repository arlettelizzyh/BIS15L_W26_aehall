...
```{r}
#setwd("/Users/alizhall/Desktop/BIS15L_W26_aehall") #change working directory
```
...
```{r}
#the mean function requires a vector to work

mean(2, 8, 2) #also does not work
```
...
NA data will ruin the result of the mean function
